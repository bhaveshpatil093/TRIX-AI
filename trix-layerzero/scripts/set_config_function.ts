...
async function setConfig(
    ...
    console.log(`setConfig - requiredDVNCount:${requiredDVNCount}, optionalDVNCount:${optionalDVNCount}`)
    ...
    const lzEndpointContract = await ethers.getContractAt(lzEndpointSetConfigABI, lzEndpointOnCurrentChain, sender)

    const messageLibAddresses = [sendLibAddressOnCurrentChain, receiveLibAddressOnCurrentChain]
    console.log('messageLibAddresses:', messageLibAddresses)
