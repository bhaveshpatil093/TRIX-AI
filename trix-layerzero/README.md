...
<h1 align="center">Omnichain Fungible Token (OFT) on Zoth Platform</h1>
...
'xdai-sepolia': {
    eid: EndpointId.XDAISEP_V2_TESTNET,
    url: process.env.RPC_URL_XDAI_TESTNET,
    accounts,
},
'polygon-sepolia': {
    eid: EndpointId.POLYSEP_V2_TESTNET,
    url: process.env.RPC_URL_POLY_TESTNET,
    accounts,
},
```
